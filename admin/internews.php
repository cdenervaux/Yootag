  ...
  <tr> 
    <td valign=top align=left height=137 bgcolor="#000000"> 
      <table cellspacing=0 cellpadding=3 width=748 align=center 
        ...
        <tr>
          <td bgcolor=#FFFFFF colspan="3" height="20" valign="top" align="center"><font face="Arial, Helvetica, sans-serif" size="-1"><b>Poster 
            une news</b></font></td>
        </tr>
        <tr> 
          <td bgcolor=#FFFFFF colspan="3" height="300" valign="top" align="left"> 
            <form method="post" action="ajouternews.php">
              <p align="center"><font face="Arial, Helvetica, sans-serif" size="-1"><br>
                ...
                <input type="text" name="titrenews_fr" size="60">
                <br>
                <br>
                <font face="Arial, Helvetica, sans-serif" size="-1">Titre de la news en anglais</font><br>
                <input type="text" name="titrenews_en" size="60">
</p>
                
              <p align="center"><font face="Arial, Helvetica, sans-serif" size="-1">Contenu de la news en fran&ccedil;ais</font> 
                <br>
                <textarea name="contenunews_fr" cols="45" rows="5"></textarea>
                <br>
                <br>
                <font face="Arial, Helvetica, sans-serif" size="-1">Contenu de la news en anglais </font><br>
                <textarea name="contenunews_en" cols="45" rows="5"></textarea>
</p>
        ...
        <tr> 
          <td bgcolor=#FFFFFF colspan="3" height="2" valign="top" align="center"><font face="Arial, Helvetica, sans-serif" size="-1"><a href="javascript:history.back()">Retour 
            &agrave; l'accueil</a></font></td>
        </tr>
        </tbody> 
      </table>
